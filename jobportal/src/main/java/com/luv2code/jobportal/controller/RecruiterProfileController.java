...
public class RecruiterProfileController {
    ...
    public String recruiterProfile(Model model) {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            Optional<RecruiterProfile> recruiter = recruiterProfileService.getOne(users.getUserId());

            recruiter.ifPresent(recruiterProfile -> model.addAttribute("profile", recruiterProfile));
